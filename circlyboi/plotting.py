...
def create_wave_animation(mesh: MeshData, data: np.ndarray, fps: int) -> ani.FuncAnimation:
    fig = plt.figure()
...
class Visualizer2D:
    ...
    def update(self, frame_data):
        ...
        return self.ax.plot_trisurf(self.mesh.xs, self.mesh.ys, frame_data,
                                    triangles=self.mesh.elements, cmap="viridis")